...
class BreadthFirstASHA:
     def __init__(self, *args, **kwargs):
         raise ImportError('laaac.breadth_first_asha.BreathFirstASHA requires ray.tune. '
                           'Please install if first. (See also: laaac.bfasha.BFASHA for '
                           'a BFASHA implementation that is not based on ray.tune.')
